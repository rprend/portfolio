...
// .wrangler/tmp/bundle-lozdEP/checked-fetch.js
...
// .wrangler/tmp/pages-s1iAP9/functionsWorker-0.3967619814860752.mjs
...
__name(createAuthChallengeResponse, "createAuthChallengeResponse");
__name2(createAuthChallengeResponse, "createAuthChallengeResponse");
    ...
    try {
      ...
      const result = await context.env.DB.prepare(
        `INSERT INTO posts (slug, title, excerpt, content, date, readTime)
         VALUES (?, ?, ?, ?, ?, ?)`
      ).bind(data.slug, data.title, excerpt, data.content, data.date, readTime).run();
      if (result.error) {
...
// .wrangler/tmp/bundle-lozdEP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lozdEP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3967619814860752.js.map
