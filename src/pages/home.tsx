  ...
  return (
    <div class="container mx-auto max-w-2xl px-4 mt-6">
      ...
      <article class="prose prose-slate mx-auto mb-12">
        ...
        <p>
          Hi, I&apos;m Ryan. I&apos;m a software engineer at{" "}
          <a href="https://www.bubble.io/" target="_blank" rel="noreferrer">
            Bubble
          </a>{" "}
          in New York.{" "}
        </p>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="bg-gray-100 p-4">
            ...
            <p>
              This site! It's a Static blog built with{" "}
          ...
          <div class="bg-gray-100 p-4">
            ...
            <p>
              Rewrite text in the style of Italo Calvino&apos;s Invisible
              Cities.{" "}
              <a
          ...
          <div class="bg-gray-100 p-4">
            ...
            <p>
              Miscellaneous generative art projects.{" "}
              <a
